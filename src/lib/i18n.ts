...
const T = {
  uk: {
    ...
    swipeDone: 'Перегляд завершено',
    swipeDoneSub: 'Можна повернутися до вподобаних або очистити вибір і пройти меню заново',
    reviewSwipeLiked: 'Переглянути вподобані',
    clearSwipeSelection: 'Очистити вибір і почати знову',
    noSwipeLikes: 'У цьому перегляді ще немає вподобаних',
  ...
  en: {
    ...
    swipeDone: 'Review complete',
    swipeDoneSub: 'Review saved picks or clear the selection and start again',
    reviewSwipeLiked: 'Review saved picks',
    clearSwipeSelection: 'Clear selection and start over',
    noSwipeLikes: 'No saved picks in this swipe session yet',
